package com.example.a201b252_sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[]winnersArray = { "airhfeusguyds" , "asdiufhwiufhaew" , "aivehgaeiurhaeiur"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.example.a201b252_sharedPreferences" , Context.MODE_PRIVATE);
